...
namespace Xevle.Maths.Tuples
{
	public struct Tuple2ds: ITuple
	{
		...
		public static implicit operator Tuple2ds(Tuple<double, double> source)
		{
			return new Tuple2ds(source.Item1, source.Item2);
		}

		public static implicit operator Tuple2ds(Tuple<float, float> source)
		{
			return new Tuple2ds(source.Item1, source.Item2);
		}

		public static implicit operator Tuple2ds(Tuple<int, int> source)
		{
			return new Tuple2ds(source.Item1, source.Item2);
		}

		public static implicit operator Tuple2ds(Tuple<double, double, double> source)
		{
			return new Tuple2ds(source.Item1, source.Item2);
		}

		public static implicit operator Tuple2ds(Tuple<float, float, float> source)
		{
			return new Tuple2ds(source.Item1, source.Item2);
		}

		public static implicit operator Tuple2ds(Tuple<int, int, int> source)
		{
			return new Tuple2ds(source.Item1, source.Item2);
		}
		#endregion
