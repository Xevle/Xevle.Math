...
namespace Xevle.Maths.Tuples
{
	...
	public struct Tuple3ds: ITuple
	{
		...
		public static Tuple3ds operator+(Tuple3ds a, ITuple b)
		{
			return new Tuple3ds(a.x + b.X, a.y + b.Y, a.z + b.Z);
		}
		...
		/// <param name="a">The first Tuple</param>
		/// <param name="b">The second Tuple as ITuple</param>
		public static double operator *(Tuple3ds a, ITuple b)
		{
			return a.x * b.X + a.y * b.Y + a.z * b.Z;
		}
		...
		public static implicit operator Tuple3ds(Tuple<double, double> source)
		{
			return new Tuple3ds(source.Item1, source.Item2);
		}

		public static implicit operator Tuple3ds(Tuple<float, float> source)
		{
			return new Tuple3ds(source.Item1, source.Item2);
		}

		public static implicit operator Tuple3ds(Tuple<int, int> source)
		{
			return new Tuple3ds(source.Item1, source.Item2);
		}

		public static implicit operator Tuple3ds(Tuple<double, double, double> source)
		{
			return new Tuple3ds(source.Item1, source.Item2, source.Item3);
		}

		public static implicit operator Tuple3ds(Tuple<float, float, float> source)
		{
			return new Tuple3ds(source.Item1, source.Item2, source.Item3);
		}

		public static implicit operator Tuple3ds(Tuple<int, int, int> source)
		{
			return new Tuple3ds(source.Item1, source.Item2, source.Item3);
		}
		#endregion
